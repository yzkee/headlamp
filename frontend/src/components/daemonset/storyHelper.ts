 ...
 */
export const DAEMONSET_DUMMY_DATA: KubeObjectInterface[] = [
  {
    apiVersion: 'apps/v1',
    kind: 'DaemonSet',
    metadata: {
...
export const DAEMONSET_NO_TOLERATIONS: KubeObjectInterface = {
  ...DAEMONSET_DUMMY_DATA[0],
  metadata: {
    ...DAEMONSET_DUMMY_DATA[0].metadata,
    name: 'gadget-no-tolerations',
    uid: 'def456',
  },
  spec: {
    ...DAEMONSET_DUMMY_DATA[0].spec,
    template: {
      ...DAEMONSET_DUMMY_DATA[0].spec.template,
      spec: {
        ...DAEMONSET_DUMMY_DATA[0].spec.template.spec,
        tolerations: [],
      },
    },
  },
