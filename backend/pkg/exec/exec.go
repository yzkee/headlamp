...
//nolint:funlen,gochecknoinits,gocritic,gosec,govet,lll,noctx,staticcheck,wsl_v5 // Preserve the adapted client-go implementation to ease upstream comparison.
package exec
